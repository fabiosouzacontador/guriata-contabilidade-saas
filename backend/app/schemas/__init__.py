...
Exporta todos os schemas para que o código existente continue funcionando
com o import  `from app import schemas`.

Estrutura:
  schemas/user.py  → Token, TokenData, UserCreate, UserLogin, UserResponse,
                     CompanyCreate, CompanyResponse
  schemas/__init__ → Escola, Turma, Aluno, Conta, Lancamento, FeedbackIA schemas
"""
...
# ── Dependências dos schemas restantes ────────────────────────────────────────
